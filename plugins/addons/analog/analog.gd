...
func map_analog_dpad():
	Input.action_press("roll_left") if currentForce.x < -0.2 else Input.action_release("roll_left")
	Input.action_press("roll_right") if currentForce.x > 0.2 else Input.action_release("roll_right")
	Input.action_press("pitch_down") if currentForce.y < -0.2 else Input.action_release("pitch_down")
	Input.action_press("pitch_up") if currentForce.y > 0.2 else Input.action_release("pitch_up")
